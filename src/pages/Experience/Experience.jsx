  ...
  const experiences = [
    {
      ...
      period: "2023 - 2024",
      description:
        "Built a real-time MERN chat application with Socket.io, JWT authentication, and responsive UI.",
    },
    {
      icon: Code2,
      ...
      period: "2025 - Present",
      description:
        "Developing scalable full-stack solutions across frontend, backend, mobile, and cloud deployment.",
    },
  ];
